...
class get_model(nn.Module):
    def __init__(self,num_class,normal_channel=True):
        ...
        # TODO is it faster if npoints is a 2^n number
        self.sa1 = PointNetSetAbstractionMsg(npoint=263, radius_list=[0.1, 0.2, 0.4], nsample_list=[16, 32, 128],
        ...
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=640 + 3,
